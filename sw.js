...
const CACHE = CACHE_PREFIX + 'v21-compact1390-finalQA';
const ASSETS = [
  ...
  './data.js','./qa-data-patch.js','./qa-b-context-patch.js','./qa-b-design-patch.js','./qa-b-overlap-patch.js','./qa-c-style-patch.js','./core.js','./qa-progress-migration.js','./data-transfer.js','./results.js','./memory.js'
];
