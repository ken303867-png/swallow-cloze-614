...
const CACHE = CACHE_PREFIX + 'v19-compact1390-qaSAB2';
const ASSETS = [
  ...
  './data.js','./qa-data-patch.js','./qa-b-context-patch.js','./qa-b-design-patch.js','./core.js','./qa-progress-migration.js','./data-transfer.js','./results.js','./memory.js'
];
