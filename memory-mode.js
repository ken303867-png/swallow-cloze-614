(()=>{
'use strict';
const PATCH_VERSION='memory-round-v1';
...
function renderMemoryCard(){
  ...
  showAnswerBtn.textContent=memorySession.answerShown?'答え表示中':'答えを表示';
  showAnswerBtn.disabled=!!memorySession.answerShown;
...
function memoryShowAnswer(){
  ...
  memorySession.answerShown=true;
  renderMemoryCard();
}
